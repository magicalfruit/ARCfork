...
RUN apt install -y \
ca-certificates fonts-liberation libasound2 libatk-bridge2.0-0 libatk1.0-0 libc6 libcairo2 libcups2 libdbus-1-3 libexpat1 \
...
libxss1 libxtst6 lsb-release wget xdg-utils curl imagemagick git
